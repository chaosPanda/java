...
class Fahrzeug
{
	...
	void initFahrzeug(String marke, String modell, String art, int kilometer, int ps, int hoechstgeschwindigkeit, int baujahr, String farbe, int anzahlTueren, String brennstoff, double preis)
	{
		this.marke = marke;
		this.modell = modell;
		this.art = art;
