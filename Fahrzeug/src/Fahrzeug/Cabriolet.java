...
class Cabriolet extends Fahrzeug
{
	...
	Cabriolet (String marke, String modell, String art, int kilometer, int ps, int hoechstgeschwindigkeit, int baujahr, String farbe, int anzahlTueren, String brennstoff, double preis, String mechanismus, String material, int schliessZeit)
	{
